...
class HellowAboutLogic extends GetxController {

  aboutHelloPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutHelloUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can provide you with text, background color modification demonstration"""),
      ],
      context: context,
    );
  }
